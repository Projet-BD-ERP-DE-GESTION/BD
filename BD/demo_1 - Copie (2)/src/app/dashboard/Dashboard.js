...
export class Dashboard extends Component {
  ...
  marketingOverviewData= {
    labels: ["Site1", "Site2", "Site3", "Site4", "Site5", "Site6", "Site6", "Site7"],
    datasets: [{
        label: 'OVERDUE',
      ...
      <div>
        ...
        <div className="row">
          <div className="col-md-8 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title mb-0"><b>statistique de comparaison</b></h4>
                <div className="d-xl-flex flex-column flex-lg-row">
                  <p>Comparaison entre le supermarché ayant effectuer le plus de ventes contre celui ayant fait le moins</p>
                  <ul className="nav nav-tabs sales-mini-tabs ml-lg-auto mb-4 mb-md-0" role="tablist">
                    ...
                    <li className="nav-item">
                      <button className={`nav-link ${this.state.active === "sales-statistics_switch_2"? 'active': ''}`} id="sales-statistics_switch_2" onClick={this.changeChartTwoData} data-toggle="tab" role="tab" aria-selected="false">3D</button>
                    </li>
                    <li className="nav-item">
                      <button className={`nav-link ${this.state.active === "sales-statistics_switch_3"? 'active': ''}`} id="sales-statistics_switch_3" onClick={this.changeChartThreeData} data-toggle="tab" role="tab" aria-selected="false">5D</button>
                    </li>
                    <li className="nav-item">
                      <button className={`nav-link ${this.state.active === "sales-statistics_switch_4"? 'active': ''}`} id="sales-statistics_switch_4" onClick={this.changeChartFourData} data-toggle="tab" role="tab" aria-selected="false">7D</button>
                    </li>
                  </ul>
                </div>
                <div className="d-xl-flex flex-column flex-lg-row">
                  ...
                  <div className="chartjs-legend line-legend">
                    <ul>
                      <li>
                        <span className="bg-info"></span>Site 1
                      </li>
                      <li>
                        <span className="bg-success"></span>Site 2
                      </li>
                    </ul>
                  </div>
                  </div>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body d-flex flex-column">
                <div className="wrapper">
                  <h4 className="card-title mb-0"><b>Classement par categories</b></h4>
                  <p>Classement par categorie et par sites minimale et maximal</p>
                  <div className="mb-4 rounded-legend" id="net-profit-legend">
                  <ul>
                    <li>
                      <span className="bg-success"></span>Site 1
                    </li>
                    <li>
                      <span className="bg-info"></span>Site 2
                    </li>
                  </ul>
                  </div>
                </div>
          ...
          <div className="col-md-8">
            <div className="row">
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title mb-0"><b>Moyen de payement le plus utiliser</b></h4>
                    <div className="d-flex align-items-center justify-content-between w-100">
                      <p className="mb-0">Comparaison des moyen de payement par site</p>
                    </div>
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex justify-content-between">
                      <h4 className="card-title mb-0"><b>Liste des fourniseurs</b></h4>
                      <a href="!#" onClick={evt =>evt.preventDefault()}><small>Show All</small></a>
                    </div>
                    <p>Liste des fourniseurs par categorie de Produit et Status</p>
          ...
          <div className="col-md-4">
            <div className="row">
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <h1 className="card-title mb-4"><b>Varisation des ventes par categories</b></h1>
                    <div className="row">
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title mb-0">Top Performences par vendeurs</h4>
